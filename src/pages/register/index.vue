<template>
  <view class="container">
    ...
    <view class="brand">
      ...
      <view class="brand-sub">开始守候你的一棵树</view>
    </view>
    ...
    <view class="form-card">
      ...
      <view class="input-wrap">
        <input class="input-field" v-model="nickname" placeholder="昵称（可选）" placeholder-style="color:#aaa" />
      </view>
      <view class="input-wrap">
        <input class="input-field" v-model="password" placeholder="密码（至少6位）" placeholder-style="color:#aaa" type="password" />
      </view>
      ...
      <view class="switch-row">
        <text class="switch-muted">已有账号？</text>
        <text class="switch-link" @click="goLogin">去登录</text>
      </view>
    </view>
  </view>
</template>
...
.brand { text-align: center; margin-bottom: 56rpx; position: relative; z-index: 1; }
